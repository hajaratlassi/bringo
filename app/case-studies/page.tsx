...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez les études de cas Bringo et des résultats mesurables en acquisition client, recherche IA, conversion et automatisation.",
};
          ...
          <div className="grid items-end gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <h1 className="mt-6 max-w-[600px] text-6xl font-extrabold leading-[1.05] tracking-tight md:text-7xl">
                Des résultats
                <br />
                <span className="text-[#08afd0]">en Europe.</span>
              </h1>
            </div>
              ...
              <div className="p-7">
                ...
                <div className="grid grid-cols-3">
                  ...
                  <div className="border-r border-[#dce5ef] text-center">
                    ...
                    <p className="mt-1 text-sm text-[#58708e]">Ventes</p>
                  </div>
